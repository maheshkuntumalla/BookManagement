...
### Key points
- I have created a database `BookManagement` in MangoDB.
- I have Followed the following steps and the naming conventions exactly as mentioned below.
...
## Books API
### POST /books
- Create a book document from the request body. Get userId in the request body only.
- Make sure the userId is a valid userId by checking the user's exist in the user's collection.
